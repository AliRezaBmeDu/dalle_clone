    ...
    <section className='max-w-7xl mx-auto'>
      ...
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        <div className="flex flex-col gap-5">
          ...
          {/* here AI generated image will be shown */}
          <div className='relative bg-gray-50 border
            border-gray-300 text-gray-900 text-sm rounded-1g 
            ...
            flex justify-center items-center'>
            {
              ...
              <img
                src={preview}
                alt="preview"
                className='w-9/12 h-9/12 obect-contain 
                opacity-40'
              />
              )
            }
        ...
        <div className='mt-10'>
            <p className='mt-2 text-[@666e75] text-[14px]'>Once you have created the Image you want,
             you can share that with your community</p>
             <button type="submit"
