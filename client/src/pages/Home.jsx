...
const Home = () => {
  ...
  const [allpPosts, setAllPosts] = useState(null)
  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        max-w-[500px]'>Browse through a collection of visually stunning images
        generated by DALL-E Artificial Intelligence</p>
      </div>
      <div className='mt-16'>
        <FormField />
      </div>
